...
negative result may reflect single-loop inference rather than RL training. \emph{PPA}: open
...
note larger designs $+$ a commercial flow as the path to signoff-grade claims. \emph{Nondeterminism}:
...
\bibitem{horizon} HORIZON: Agentic Hardware Design as Repository-Level Code Evolution. arXiv:2606.28279.
\bibitem{cvdp} Comprehensive Verilog Design Problems (CVDP). arXiv:2506.14074.
\bibitem{specbench} SpecBench: Measuring Reward Hacking in Long-Horizon Coding Agents. arXiv:2605.21384.
\bibitem{evilgenie} EvilGenie: A Reward Hacking Benchmark. arXiv:2511.21654.
\bibitem{vericontam} VeriContaminated: Assessing LLM-Driven Verilog Coding for Data Contamination. arXiv:2503.13572.
\bibitem{trace2skill} Trace2Skill: Verifier-Guided Skill Evolution for Long-Context EDA Agents. arXiv:2605.21810.
\bibitem{notsotiny} NotSoTiny: A Large, Living Benchmark for RTL Code Generation. arXiv:2512.20823.
\bibitem{realbench} RealBench: Benchmarking Verilog Generation Models with Real-World IP Designs. arXiv:2507.16200.
\bibitem{frontier} Exploring the Agentic Frontier of Verilog Code Generation. arXiv:2603.19347.
\bibitem{tokenalloc} Understanding Inference-Time Token Allocation and Coverage Limits in Agentic Hardware Verification. arXiv:2604.15657.
\end{thebibliography}
