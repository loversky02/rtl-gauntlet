...
hacks no more. Both residual \rhg{} counter-examples are verified artifacts of the BMC zero-init assumption
(\code{-set-init-zero} forces an invalid state for an async-reset/one-hot FSM); the $5$ \code{dontcare}
