...
| R14 | **Contamination / memorization** | 🔴 | open | RTLLM/VerilogEval/CVDP are public → an "honest pass" may be recalled golden, not reasoning. Mutate tasks (rename, re-parameterize, perturb), prefer living/fresh items, and run a contamination check (cf. VeriContaminated). |
